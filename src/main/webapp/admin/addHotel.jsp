              ...
              <div class="row">
         		...
         		<form class="row g-3"  id="myform"  method="post"  enctype="multipart/form-data" >
                        <div class="col-12">
                          ...
                          <input type="text" name="hname" class="form-control" placeholder="Enter Hotel Name" required>
                          <input type="hidden" name="event" value="addHotel">
                        </div>
                        
                        <div class="col-12">
                          <label class="form-label">Description</label>
                        <textarea type="text" class="form-control"  name="hdesc" placeholder="Write about your hotel.." required></textarea>
                        </div>
                        <div class="col-12">
                          <label class="form-label">Hotel Address</label>
                        <input type="text"  class="form-control" name="haddress" placeholder="Enter your hotel Address" required>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                          <input type="submit" class="btn btn-primary px-4"  id="submit" value="Add Hotel">
                        </div>
                  </form>
                      </div>
                     </div>
