      ...
      <%@include file="include/sidebar.jsp" %>
       ...
       <!--start content-->
         ...
         <form class="row g-3"  id="myform" method="post"  enctype="multipart/form-data" >
                        ...
                        <input type="text"  class="form-control" name="cno" placeholder="Enter Phone Number" required>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                          <input type="submit" class="btn btn-primary px-4"  id="submit" value="Add Admin">
                        </div>
                      </form>
                      </div>
                     </div>
