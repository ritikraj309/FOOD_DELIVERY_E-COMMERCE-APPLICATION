              ...
              <li class="nav-item dropdown dropdown-large">
                <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">
                  <div class="user-setting d-flex align-items-center gap-1">
                    <img src="./assets/adminImg/<% out.print(request.getSession().getAttribute("image")); %>" class="user-img" alt="">
                    <div class="user-name d-none d-sm-block"><% out.print(request.getSession().getAttribute("name")); %></div>
                  </div>
                </a>
                  ...
                  <li>
                     <a class="dropdown-item" href="#">
                       <div class="d-flex align-items-center">
                          <img src="./assets/adminImg/<% out.print(request.getSession().getAttribute("image")); %>" alt="" class="rounded-circle" width="60" height="60">
                          <div class="ms-3">
                            <h6 class="mb-0 dropdown-user-name"><% out.print(request.getSession().getAttribute("name")); %></h6>
