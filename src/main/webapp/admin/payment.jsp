	    			...
	    			success:function(data,textStatus,jqXHR){ 					 
	    				...
	    				for (var key in data) {
	    					if (data.hasOwnProperty(key)) {
	    					  s+="<tr>";
	    					  s+="<td>"+data[key].payment_id+"</td>";
	    					  s+="<td>"+data[key].name+"</td>";	    					  
	    					  s+="<td>"+data[key].transcation_id+"</td>";
	    					  s+="<td>"+data[key].total_amount+"</td>";
	    					  s+="<td>"+data[key].payment_date+"</td>";
	    					  s+="<td>"+data[key].card_num+"</td>";
	    					  s+="<td>"+data[key].expairy_date+"</td>";
	    					  s+="<td>"+data[key].cvv+"</td></tr>";
	    					}
	    				}
	    				$('#view_order').html(s);
	    				console.log("success...")
